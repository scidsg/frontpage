...
class Article(db.Model):
    ...
    download_link = db.Column(db.String(2000))
    download_link2 = db.Column(db.String(2000))
    download_link3 = db.Column(db.String(2000))
    magnet_link = db.Column(db.String(2000))
    magnet_link2 = db.Column(db.String(2000))
    magnet_link3 = db.Column(db.String(2000))
    torrent_link = db.Column(db.String(2000))
    torrent_link2 = db.Column(db.String(2000))
    torrent_link3 = db.Column(db.String(2000))
    ipfs_link = db.Column(db.String(2000))
    ipfs_link2 = db.Column(db.String(2000))
    ipfs_link3 = db.Column(db.String(2000))
