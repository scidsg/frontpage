...
Revision ID: 969132890ea8
Revises: 
Create Date: 2024-04-22 13:33:22.289997
...
def upgrade():
    ...
    article_type_table = op.create_table(
        "article_types",
    ...
    # List of predefined article types
    article_types = [
        {"name": "Allegations of State Sponsorship"},
        {"name": "Banker's Box"},
        {"name": "Corporate"},
        {"name": "Cyberwar"},
        {"name": "Environmental"},
        {"name": "European Union"},
        {"name": "Extractivist Leaks"},
        {"name": "Fascist"},
        {"name": "Fuerzas Represivas"},
    ...
    # Insert predefined article types into the article_types table
    op.bulk_insert(article_type_table, article_types)
    ...
    op.create_table(
        ...
        sa.Column(
            "include_in_team_page", sa.Boolean(), server_default=sa.text("(FALSE)"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["article_id"], ["articles.id"], name=op.f("fk_article_categories_article_id_articles")
        ),
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
