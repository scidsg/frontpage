"""Initial migration script for database setup and default data seeding.
...
def upgrade():
    ...
    # Create 'article_type' table and insert default article types
    op.create_table(
        'article_type',
        sa.Column('id', sa.Integer, nullable=False),
    ...
    article_types = [
        {'name': 'Allegations of State Sponsorship'}, {'name': 'Banker\'s Box'},
        {'name': 'Corporate'}, {'name': 'Cyberwar'}, {'name': 'Environmental'},
        {'name': 'European Union'}, {'name': 'Extractivist Leaks'}, {'name': 'Fascist'},
        {'name': 'Fuerzas Represivas'}, {'name': 'Hack'}, {'name': 'Leak'},
        {'name': 'Leak Markets'}, {'name': 'Limited Distribution'}, {'name': 'MilicoLeaks'},
        {'name': 'News'}, {'name': 'Official'}, {'name': 'Opinion'}, {'name': 'Organization'},
        {'name': 'Other'}, {'name': 'Ransomware'}, {'name': 'Researchers'}, {'name': 'Scrape'}
    ]
    op.bulk_insert(sa.table('article_type',
